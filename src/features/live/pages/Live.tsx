...
const Live: React.FC = () => {
    ...
    return (
      <div className="w-full bg-white rounded-2xl shadow-lg p-6 border border-[#f87171] text-center">
        ...
        <button
          ...
          className="bg-red-600 text-[var(--font-light)] px-4 py-2 rounded hover:bg-red-700 transition"
        >
          🔄 Retry
        </button>
      </div>
  ...
  return (
    <div className="min-h-screen bg-[var(--neutral-50)] py-6 px-4 sm:px-6 lg:px-8">
