        ...
        {!email ? (
          <div className="text-center">
            ...
            <button
              ...
              className="px-6 py-3 bg-[var(--default-primary)] text-white rounded-xl hover:bg-[#1E4A63] transition-all duration-200"
            >
              Go to Signup
            </button>
          </div>
          ...
          <>
            ...
            <div className="flex justify-between w-full max-w-sm">
              ...
              <button
                onClick={() => navigate("/signup")}
                className="w-auto h-10 px-6 text-sm rounded-xl text-[#343A40] bg-[#E9ECEF] font-medium transition-all duration-200 hover:bg-[var(--netural-200)] hover:scale-95"
              >
                Back
              </button>
              ...
              <button
                ...
                className="w-auto h-10 px-6 text-sm rounded-xl text-white bg-[var(--default-primary)] font-medium transition-all duration-200 hover:bg-[#1E4A63] hover:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
              >
