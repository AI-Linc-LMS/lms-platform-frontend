  ...
  return (
    <div className="flex-1 max-w-full">
      ...
      <div className="bg-gray-100 p-3 md:p-4 flex justify-end">
        <button
          onClick={nextContent}
          className="px-3 md:px-4 py-2 bg-[var(--default-primary)] text-white text-sm md:text-base rounded-xl flex items-center cursor-pointer"
        >
      ...
      <div className="flex justify-between items-center my-4 px-2 md:px-0">
        ...
        <div>
          ...
          >
            ...
            <p className="text-[var(--secondary-300)] font-medium text-xs md:text-sm">
              Report an issue
            </p>
          </button>
        </div>
          ...
          <button
            ...
            className={`whitespace-nowrap py-3 md:py-4 px-1 border-b-2 font-medium text-xs md:text-sm ${
              activeTab === "description"
                ? "border-[var(--default-primary)] text-[var(--default-primary)]"
