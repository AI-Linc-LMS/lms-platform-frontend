      ...
      >
        ...
        <div className="actions mt-4 flex flex-col md:flex-row justify-between gap-2 md:gap-0">
          <div className="flex flex-col md:flex-row gap-2">
            <button
              onClick={openPreview}
              className="bg-[var(--primary-500)] hover:bg- text-[var(--font-light)] px-3 md:px-4 py-1.5 md:py-2 rounded-md text-xs md:text-sm font-medium flex items-center justify-center md:justify-start cursor-pointer scale-100 hover:scale-105 transition-transform duration-200"
            >
