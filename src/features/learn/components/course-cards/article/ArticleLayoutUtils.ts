...
export const ARTICLE_LAYOUT_TEMPLATES = {
  ...
  DEFAULT: {
    container: {
      className:
        "max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-sm relative pb-10",
    },
    header: {
    ...
    actions: {
      ...
      buttonClassName:
        "flex items-center gap-2 px-6 py-6 rounded-3xl text-base font-medium bg-[var(--secondary-500)] text-white transition hover:bg-[var(--secondary-600)]",
  ...
  COMPACT: {
    container: {
      className:
        "max-w-2xl mx-auto p-4 bg-white rounded-md shadow-sm relative pb-6",
    },
    header: {
    ...
    actions: {
      ...
      buttonClassName:
        "flex items-center gap-2 px-4 py-3 rounded-2xl text-sm font-medium bg-[var(--secondary-500)] text-white transition",
      buttonText: "Complete",
      showIcon: true,
    },
  } as ArticleLayoutConfig,
  ...
  IMMERSIVE: {
    container: {
      className:
        "w-full min-h-screen bg-gradient-to-br from-gray-50 to-white relative",
    ...
    header: {
      ...
      marksClassName:
        "text-xl font-semibold text-white bg-gradient-to-r from-[var(--secondary-400)] to-[#005a7a] px-4 py-2 rounded-lg shadow-lg",
    },
    content: {
      className:
        "course-description prose prose-xl max-w-none text-gray-800 leading-relaxed",
      wrapperClassName:
        "max-w-6xl mx-auto bg-white rounded-2xl shadow-xl p-12 mb-12",
    },
    actions: {
      className: "max-w-6xl mx-auto flex justify-center",
      buttonClassName:
        "flex items-center gap-3 px-8 py-4 rounded-full text-lg font-semibold bg-gradient-to-r from-[var(--secondary-500)] to-[var(--secondary-600)] text-white transition transform hover:scale-105 shadow-lg",
      buttonText: "Mark as Completed",
      showIcon: true,
    },
  } as ArticleLayoutConfig,
  ...
  MINIMAL: {
    ...
    content: {
      className:
        "course-description prose prose-lg max-w-none text-gray-700 font-light leading-loose",
  ...
  CARD: {
    ...
    header: {
      className:
        "bg-white rounded-t-xl shadow-sm border border-gray-200 p-6 flex justify-between items-center",
      showTitle: true,
      showMetadata: true,
      showMarks: true,
      ...
      metadataClassName: "flex items-center gap-4 text-sm text-gray-500",
      marksClassName:
        "bg-[var(--secondary-400)] text-white px-3 py-1 rounded-full text-sm font-medium",
    },
    content: {
    ...
    actions: {
      ...
      buttonClassName:
        "flex items-center gap-2 px-6 py-3 rounded-lg text-base font-medium bg-[var(--secondary-500)] text-white transition hover:bg-[var(--secondary-600)]",
  ...
  DARK: {
    container: {
      className:
        "max-w-4xl mx-auto p-6 bg-gray-900 rounded-lg shadow-2xl relative pb-10",
    },
    header: {
      className:
        "flex justify-between items-center mb-6 border-b border-gray-700 pb-4",
      showTitle: true,
      showMetadata: true,
      showMarks: true,
    ...
    content: {
      className:
        "course-description prose prose-invert prose-lg max-w-none text-gray-300",
      wrapperClassName: "my-8",
    },
    actions: {
      className: "flex justify-end mt-8",
      buttonClassName:
        "flex items-center gap-2 px-6 py-6 rounded-3xl text-base font-medium bg-gradient-to-r from-[var(--secondary-400)] to-[#00a8cc] text-white transition hover:from-[#005a7a] hover:to-[var(--secondary-400)]",
      buttonText: "Mark as completed",
      showIcon: true,
    },
  } as ArticleLayoutConfig,
...
export const getLayoutTemplate = (
  templateName: keyof typeof ARTICLE_LAYOUT_TEMPLATES
): ArticleLayoutConfig => {
  return (
    ARTICLE_LAYOUT_TEMPLATES[templateName] || ARTICLE_LAYOUT_TEMPLATES.DEFAULT
  );
};
...
export const BACKEND_LAYOUT_EXAMPLES = {
  ...
  customLayout: {
    layout_config: {
      container: {
        className:
          "max-w-6xl mx-auto p-8 bg-gradient-to-r from-blue-50 to-indigo-100 rounded-2xl shadow-xl relative",
      },
      header: {
        ...
        showMarks: true,
        titleClassName:
          "text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-4",
        metadataClassName:
  ...
  responsiveLayout: {
    layout_config: {
      container: {
        className:
          "max-w-4xl mx-auto p-4 md:p-6 bg-white rounded-lg shadow-sm relative pb-10",
      },
      header: {
        className:
          "flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6",
        showTitle: true,
        showMetadata: true,
        showMarks: true,
      ...
      actions: {
        ...
        buttonClassName:
          "flex items-center gap-2 px-4 py-3 md:px-6 md:py-6 rounded-2xl md:rounded-3xl text-sm md:text-base font-medium bg-[var(--secondary-500)] text-white transition",
        buttonText: "Mark as completed",
        showIcon: true,
      },
    },
