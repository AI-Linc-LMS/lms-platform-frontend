      ...
      <div className="flex flex-col sm:flex-row gap-3 my-3 items-center justify-between">
        <div className="flex flex-row gap-3 w-full sm:w-auto justify-center sm:justify-start">
          <button
            ...
            className={`w-[100px] h-[45px] rounded-full bg-[var(--neutral-100)] flex flex-row items-center justify-center gap-2 p-3 cursor-pointer transition-colors ${
          ...
          >
            <img
              ...
              className="w-5 h-5"
            />
            <p className="font-medium text-xs sm:text-[14px] text-[var(--neutral-400)]">
        ...
        <div className="w-full sm:w-auto flex justify-center sm:justify-end mt-2 sm:mt-0">
          ...
          >
            ...
            <p className="text-[var(--secondsary-300)] font-medium text-xs sm:text-[14px]">
              Report an issue
            </p>
          </button>
        </div>
