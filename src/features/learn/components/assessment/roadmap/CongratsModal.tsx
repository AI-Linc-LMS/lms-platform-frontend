...
const CongratsModal: React.FC<CongratsModalProps> = ({ open, onClose }) => {
    ...
    return (
        <div className={`fixed inset-0 z-[9999] flex items-center justify-center transition-all duration-300 ${isVisible ? 'bg-black/50' : 'bg-black/0'}`}>
            ...
            >
                ...
                <p className="text-gray-600 mb-8 text-lg leading-relaxed">
                    <span className="font-semibold text-blue-600">Congratulations!</span> You did it! Now it's time to see where you shine. 
                    <br />
                ...
                <div className="space-y-4 mb-6">
                    <a
                        ...
                        className="group inline-flex items-center justify-center w-full px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
                    >
                ...
                <div className="border-t border-gray-200 pt-4">
                    <div className="flex items-center justify-center space-x-3 mb-3">
                        ...
                        {/* <div className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-3 py-1 rounded-full font-bold text-lg min-w-[2rem] h-8 flex items-center justify-center">
