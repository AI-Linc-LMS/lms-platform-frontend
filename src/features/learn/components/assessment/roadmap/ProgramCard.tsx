      ...
      <div className="flex flex-col lg:flex-row items-center bg-gradient-to-br from-[#f8fcfc] to-[#eafff6] rounded-2xl sm:rounded-3xl px-4 sm:px-6 lg:px-8 shadow-sm border border-gray-200">
        <div className="flex-1 min-w-[280px] sm:min-w-[300px]">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-3 sm:mt-4 text-xs sm:text-sm">
            <button className="bg-[var(--primary-500)] text-[var(--font-light)] px-3 sm:px-4 py-2 rounded-full font-semibold flex items-center gap-2 shadow hover:bg-[#1a4a5f] transition-colors">
              🚀 21-Day No-Code Product Builder
            </button>
            <button className="bg-[#0e7490] text-[var(--font-light)] px-3 sm:px-4 py-2 rounded-full font-semibold flex items-center gap-2 shadow hover:bg-[#155e75] transition-colors">
    ...
    >
      <div className="flex flex-col lg:flex-row items-center bg-gradient-to-br from-[#fffbe6] to-[#fffde6] rounded-2xl sm:rounded-3xl px-4 sm:px-6 lg:px-8 shadow-sm border border-gray-200">
        <div className="flex-1 min-w-[280px] sm:min-w-[300px]">
          ...
          <div className="mb-2">
            <span className="inline-block px-2 sm:px-3 py-1 mt-1 bg-green-600 text-[var(--font-light)] rounded-full text-xs font-semibold mb-2">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-3 sm:mt-4 text-xs sm:text-sm">
            <button className="bg-yellow-700 text-[var(--font-light)] px-3 sm:px-4 py-2 rounded-full font-semibold flex items-center gap-2 shadow hover:bg-yellow-600 transition-colors">
              🧑‍💻 21-Day No-Code Product Builder
            </button>
            <button className="bg-yellow-700 text-[var(--font-light)] px-3 sm:px-4 py-2 rounded-full font-semibold flex items-center gap-2 shadow hover:bg-yellow-800 transition-colors">
