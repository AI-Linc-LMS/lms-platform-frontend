        ...
        <div className="bg-white rounded-lg p-8 max-w-md w-full shadow-xl">
          <div className="text-center">
            ...
            <button
              ...
              className="bg-[var(--default-primary)] text-white px-4 py-2 rounded-lg hover:bg-[#1e4a61] transition-colors"
            >
              Close
            </button>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-6">
            ...
            <div className="flex-1 bg-gradient-to-br from-[#B8E6F0] to-[#E0F4F8] rounded-2xl p-6 sm:p-8 relative overflow-hidden mb-4 md:mb-0">
              <div className="relative z-10">
                <p className="text-[var(--default-primary)] text-base sm:text-lg mb-2">
                  You have scored
                </p>
                <div className="flex items-baseline mb-4">
                  <span className="text-5xl sm:text-6xl md:text-7xl font-bold text-[var(--default-primary)]">
                    {redeemData?.score}
                  </span>
                  <span className="text-2xl sm:text-3xl md:text-4xl text-[var(--default-primary)] ml-2">
                    /30
                  </span>
                </div>
                <div className="flex flex-col gap-2 text-[var(--default-primary)]">
            ...
            <div className="w-full md:w-80 bg-gradient-to-br from-[var(--default-primary)] to-[#1a4a5f] rounded-2xl p-6 sm:p-8 text-white relative overflow-hidden">
              <div className="relative z-10">
                ...
                {isPurchased ? (
                  ...
                  <button
                    ...
                    className="w-full bg-white text-[var(--default-primary)] py-3 px-6 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-200 flex items-center justify-center gap-2"
                  >
