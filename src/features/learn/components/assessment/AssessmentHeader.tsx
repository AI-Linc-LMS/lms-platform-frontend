    ...
    <div className="bg-white rounded-lg p-3 sm:p-4 mb-4 sm:mb-6 shadow-sm">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0">
        <button
          ...
          className="flex items-center text-[var(--default-primary)] hover:text-[#1a4a5f] mb-2 sm:mb-0"
        >
          <svg
        ...
        <div className="text-left sm:text-right w-full sm:w-auto">
          ...
          <div className="text-base sm:text-lg font-semibold text-[var(--default-primary)]">
