    ...
    >
      ...
      <div className="p-3 sm:p-4 md:p-6">
        ...
        <div className="mt-auto">
          <button
            onClick={onExpand}
            className={`px-5 py-3 mt-7.5 border-none rounded-lg text-base font-semibold cursor-pointer transition-all duration-200 text-center bg-[var(--course-cta)] text-[var(--font-light)] hover:bg-[#059669] hover:-translate-y-0.5 ${"w-full"} ${className}`}
          >
            View More
          </button>
        </div>
