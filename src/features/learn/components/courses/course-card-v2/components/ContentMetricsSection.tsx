...
const CONTENT_METRICS: ContentMetric[] = [
  {
    ...
    icon: Video,
    label: "Videos",
    getValue: (course: Course) => course.stats?.video?.total || 0,
  ...
  },
  {
    ...
    icon: FileText,
    label: "Articles",
    getValue: (course: Course) => course.stats?.article?.total || 0,
  ...
  },
  {
    ...
    icon: HelpCircle,
    label: "Quizzes",
    getValue: (course: Course) => course.stats?.quiz?.total || 0,
  ...
  },
  {
    ...
    icon: Code,
    label: "Problems",
    getValue: (course: Course) => course.stats?.coding_problem?.total || 0,
  ...
  },
  {
    ...
    icon: Edit,
    label: "Subjective",
    getValue: (course: Course) => course.stats?.assignment?.total || 0,
