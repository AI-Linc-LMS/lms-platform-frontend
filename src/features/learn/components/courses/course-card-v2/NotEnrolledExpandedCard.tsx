      ...
      <div className="p-3 sm:p-4 md:p-6">
        ...
        <div className="flex items-center ">
          ...
          <button
            ...
            className={`px-5 py-3 border-none rounded-lg text-base font-semibold cursor-pointer transition-all duration-200 text-center bg-[var(--course-cta)] text-[var(--font-light)] hover:bg-[#059669] hover:-translate-y-0.5 ${"w-full"} ${className}`}
          >
