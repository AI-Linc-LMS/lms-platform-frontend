      ...
      <div className="min-h-screen bg-gradient-to-br from-[#F8FAFC] via-[#EFF9FC] to-[#E0F4F8] flex items-center justify-center">
        <div className="text-center">
          <div className="relative">
            <div className="animate-spin rounded-full h-16 w-16 border-4 border-[var(--primary-200)] border-t-[var(--primary-500)] mx-auto"></div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F8FAFC] via-[#EFF9FC] to-[#E0F4F8]">
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-[var(--primary-500)]/5 to-[#2C5F7F]/5"></div>
        ...
        {assessments && assessments.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {assessments.map((assessment, index) => (
              ...
              >
                {/* Gradient Overlay */}
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[var(--primary-500)] to-[#2C5F7F]"></div>
                ...
                {/* Decorative Elements */}
                <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-gradient-to-br from-[var(--primary-500)]/5 to-[#2C5F7F]/5 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-500"></div>
              </div>
            ))}
          </div>
        ) : (
