...
const PhoneVerificationPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--netural-50)] flex items-center justify-center p-3 sm:p-4">
      <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-8 shadow-lg max-w-md w-full mx-auto">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-[#E8F4F8] rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
            <svg
              className="w-8 h-8 sm:w-10 sm:h-10 text-[var(--default-primary)]"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <div className="flex flex-col sm:flex-row">
              ...
              <div className="relative mb-2 sm:mb-0" ref={dropdownRef}>
                <button
                  ...
                  className="relative flex items-center justify-between w-full sm:w-auto px-3 py-3 border border-gray-300 rounded-xl sm:rounded-l-xl sm:rounded-r-none bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-[var(--default-primary)] focus:border-[var(--default-primary)] transition-colors"
                >
                    ...
                    <div className="p-3 border-b border-gray-200">
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[var(--default-primary)] focus:border-[var(--default-primary)] outline-none text-sm"
                        />
                      </div>
                    </div>
              ...
              <input
                ...
                className="flex-1 px-4 py-3 border border-gray-300 rounded-xl sm:rounded-r-xl sm:rounded-l-none sm:border-l-0 focus:ring-2 focus:ring-[var(--default-primary)] focus:border-[var(--default-primary)] outline-none transition-colors"
                maxLength={15}
              />
            </div>
          ...
          <button
            ...
            className={`w-full py-3 sm:py-4 px-6 rounded-xl font-semibold text-base sm:text-lg transition-colors ${
              isPhoneValid && !startAssessmentMutation.isPending
                ? "bg-[var(--default-primary)] text-white hover:bg-[#1a4a5f] active:bg-[#0f3a4f]"
