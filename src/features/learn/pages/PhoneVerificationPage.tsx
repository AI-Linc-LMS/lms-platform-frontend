      ...
      <div className="bg-white rounded-3xl p-8 shadow-lg max-w-md w-full mx-auto">
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="flex">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {/* Dropdown Menu */}
                {isDropdownOpen && (
                  <div className="absolute top-full left-0 z-10 w-80 mt-1 bg-white border border-gray-300 rounded-xl shadow-lg">
                    {/* Search Input */}
                      ...
                      {filteredCountries.length > 0 ? (
                        filteredCountries.map((country) => (
                          ...
                          >
                            ...
                            <span className="text-sm font-medium text-gray-900 mr-2 flex-1">{country.country}</span>
          ...
          <button
            ...
            className={`w-full py-3 px-6 rounded-xl font-semibold text-lg transition-colors ${isPhoneValid && !startAssessmentMutation.isPending
