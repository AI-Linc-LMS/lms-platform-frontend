      ...
      <div className="min-h-screen bg-gray-50 p-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex gap-6">
            ...
            <div className="flex-1 bg-gradient-to-br from-[#B8E6F0] to-[#E0F4F8] rounded-2xl p-8 relative overflow-hidden">
              <div className="relative z-10">
                <p className="text-[#255C79] text-lg mb-2">You have scored</p>
                <div className="flex items-baseline mb-4">
                  <span className="text-6xl md:text-8xl font-bold text-[#255C79]">
                    {correctAnswers}
                  </span>
                  <span className="text-3xl md:text-4xl text-[#255C79] ml-2">
                    /{questions.length}
                  </span>
                </div>
            ...
            <div className="w-80 bg-gradient-to-br from-[#255C79] to-[#1a4a5f] rounded-2xl p-8 text-white relative overflow-hidden">
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-2xl">👋</span>
                  <p className="text-lg">Hey, You are eligible for a</p>
                </div>
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg p-4 mb-6 shadow-sm">
          <div className="flex items-center justify-between">
            <button
              ...
              className="flex items-center text-[#255C79] hover:text-[#1a4a5f]"
            >
            ...
            <div className="text-center">
              <h1 className="text-lg font-semibold text-gray-800">{mockAssessmentData.title}</h1>
              <p className="text-sm text-gray-500">Solve real world questions and gain insight knowledge.</p>
            </div>
            <div className="text-right">
              <div className="text-sm text-gray-500">Time Remaining</div>
              <div className="text-lg font-semibold text-[#255C79]">{formatTime(timeRemaining)}</div>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-6">
          ...
          <div className="w-1/4 bg-white rounded-lg p-6 shadow-sm h-fit">
            ...
            <div className="grid grid-cols-3 gap-2">
              {questions.map((_, index) => (
                <button
                  ...
                  className={`py-2 px-3 rounded-md border text-sm font-medium transition ${getQuestionButtonStyle(index)}`}
                >
                  {index + 1}
                </button>
              ))}
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center">
                        <span className="font-medium mr-3 text-[#255C79]">
                          {optionLetter}.
                        </span>
