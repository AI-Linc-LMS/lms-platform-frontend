            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-red-700">
                  This course is not assigned to you. Please contact your administrator for access.
                </p>
              </div>
            </div>
          </div>
    ...
    return (
      <>
        ...
        <div className="flex flex-col gap-4 p-4">
          {!isLoading && <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-md">
            <div className="flex">
              <div className="flex-shrink-0">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-700">
                  Course data is currently unavailable. Please try refreshing the page or contact support if the issue persists.
                </p>
              </div>
            </div>
          </div>}
                ...
                <div className="overflow-hidden rounded-xl border border-gray-300">
                  <table className="w-full text-center border-collapse">
                    <thead className="bg-gray-100">
                      <tr>
                        <th className="border-b border-gray-300 px-2 py-3 text-xs text-gray-600">Standing</th>
                        <th className="border-b border-l border-gray-300 px-2 text-xs text-gray-600">Name</th>
                        <th className="border-b border-l border-gray-300 px-2 text-xs text-gray-600">Marks</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[...Array(6)].map((_, index) => (
