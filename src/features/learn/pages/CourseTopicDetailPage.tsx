            ...
            {activeTab === "description" && (
              <div>
                <h2 className="text-xl font-bold mb-4">
                  Are you ready to embark on an exhilarating journey of
                  discovery?
                </h2>
                <p className="mb-4">
                  Brace yourself as we delve into the captivating world of
                  Arrays. Prepare to unlock the power of organized data, where
                  each element holds a unique story waiting to be explored.
                  Embrace the thrill of manipulating, sorting, and transforming
                  arrays, and witness the magic as your code springs to life!!!
                </p>
                ...
                <p className="mb-4">
                  ...
                  at contiguous memory locations. This makes it easier to
                  calculate the position of each element by simply adding an
                  offset to a base value, i.e., the memory location of the first
                  element of the array (generally denoted by the name of the
                  array).
                </p>
                ...
                <div className="border rounded-lg p-4 my-6">
                  ...
                  <div className="flex justify-center">
                    <div className="flex">
                      <div className="w-12 h-12 bg-gray-200 flex items-center justify-center border border-gray-300">
                        2
                      </div>
                      <div className="w-12 h-12 bg-gray-200 flex items-center justify-center border border-gray-300">
                        4
