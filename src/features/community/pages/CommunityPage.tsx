...
const CommunityPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="bg-white rounded-xl p-8 max-w-md w-full shadow-2xl transform transition-all duration-300 scale-100 opacity-100">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Our community feature is currently under development. We're building an amazing space for learners to connect, share knowledge, and help each other grow.
              </p>
              ...
              <div className="text-left mb-8 space-y-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-gray-700">Q&A with instructors</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  <span className="text-sm text-gray-700">Peer-to-peer learning</span>
                </div>
                <div className="flex items-center gap-3">
      ...
      {/* Existing content with blur effect when modal is open */}
      <div className={`transition-all duration-300 ${showComingSoonModal ? 'filter blur-sm pointer-events-none' : ''}`}>
