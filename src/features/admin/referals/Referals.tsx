  ...
  if (isLoading)
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[var(--default-primary)]"></div>
      </div>
    );
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[var(--default-primary)] focus:border-transparent outline-none"
            />
          </div>
          ...
          <select
            ...
            className="px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[var(--default-primary)] focus:border-transparent outline-none"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 bg-[var(--default-primary)] text-white px-6 py-3 rounded-lg hover:bg-[#1E4A63] transition-colors font-medium"
          >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[var(--default-primary)] focus:border-transparent outline-none ${
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              className="flex-1 px-4 py-2 bg-[var(--default-primary)] text-white rounded-lg hover:bg-[#1E4A63] transition-colors disabled:opacity-50"
              disabled={isLoading}
            >
