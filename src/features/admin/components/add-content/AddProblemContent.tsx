...
const AddProblemContent: React.FC<AddProblemContentProps> = ({ onBack }) => {
    ...
    const handleSave = () => {
        ...
        console.log({ title, level, topic, languages, testCases, marks, statement });
        alert("Problem content saved!");
    };

    const colorOptions = [
        "#2D3748", "#E53E3E", "#DD6B20", "#D69E2E", "#38A169", "#319795", "#3182CE", "#805AD5", "#D53F8C", "#000000"
    ];
    ...
    const handleInput = (e: React.FormEvent<HTMLDivElement>) => {
        ...
        const isEmpty = content.trim() === '' || content === '<br>' || content === '<div></div>' || content === '<p></p>';
            ...
            <div className="border border-gray-300 rounded-lg p-2 px-4 space-y-4">
                <div className="flex flex-wrap gap-4 mb-4">
                    ...
                    <div className="flex-1 min-w-[180px]">
                        <label className="text-sm font-medium text-gray-700">Level of Problem</label>
                        <select
                            value={level}
                ...
                <div className="flex flex-wrap gap-4 mb-4">
                    <div className="flex-1 min-w-[220px]">
                        <label className="text-sm font-medium text-gray-700">Choose Code Languages</label>
                        <select
                            value={languages}
                    ...
                    <div className="flex-1 min-w-[220px]">
                        <label className="text-sm font-medium text-gray-700">Test Cases (Optional)</label>
                        <input
                            type="text"
                            placeholder="Enter or paste test cases here"
                            value={testCases}
                ...
                <div className="border rounded-lg overflow-hidden mt-3">
                    <div className="bg-[#D7EFF6] px-4 py-2 border-b flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button className="cursor-pointer hover:bg-gray-200 p-1 rounded" onClick={() => execCommand("justifyLeft")}> <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16" /> </svg> </button>
                            <button className="cursor-pointer hover:bg-gray-200 p-1 rounded" onClick={() => execCommand("justifyCenter")}> <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 10h16M4 14h8" /> </svg> </button>
                            <button className="cursor-pointer hover:bg-gray-200 p-1 rounded" onClick={() => execCommand("justifyFull")}> <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" /> </svg> </button>
                            <div className="h-4 border-r border-gray-300"></div>
                            <button className="cursor-pointer hover:bg-gray-200 p-1 rounded" onClick={() => execCommand("insertOrderedList")}> <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /> </svg> </button>
                            <button className="cursor-pointer hover:bg-gray-200 p-1 rounded" onClick={() => { const date = new Date().toLocaleDateString(); execCommand("insertText", date); }}> <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /> </svg> </button>
                            <button className="cursor-pointer hover:bg-gray-200 p-1 rounded" onClick={() => { const url = prompt("Enter the URL:"); if (url) execCommand("createLink", url); }}> <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" /> </svg> </button>
                        </div>
                    </div>
