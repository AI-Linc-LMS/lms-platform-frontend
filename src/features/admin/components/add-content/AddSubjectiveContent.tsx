...
const AddSubjectiveContent: React.FC<AddSubjectiveContentProps> = ({ onBack }) => {
    ...
    const handleSave = () => {
        ...
        console.log({ title, marks, answer });
        alert("Content saved!");
    };
                ...
                <div className="flex gap-4 mb-4">
                    <div className="flex flex-col md:flex-row gap-4 w-full">
                        <div className="flex-1">
                            <label className="text-sm font-medium text-gray-700">Subjective Title</label>
                            <input
                                type="text"
