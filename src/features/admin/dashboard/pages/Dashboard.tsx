  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center text-[var(--default-primary)] text-sm gap-2">
      ...
      <div className="flex gap-4">
        {metrics.map((metric, idx) => (
          ...
          >
            <div>
              <div className="text-xs text-[var(--default-primary)] flex items-center gap-1 mb-2">
                {metric.label}
                <span className="ml-1 text-gray-400 cursor-pointer">
                  <img src={i} alt="i" className="w-4 h-4" />
                </span>
              </div>
              <div className="text-3xl font-bold text-[var(--default-primary)]">
                {metric.value}
              </div>
            </div>
            <div className="bg-[var(--primary-50)] rounded-full p-4 flex items-center justify-center border border-[var(--default-primary)]">
