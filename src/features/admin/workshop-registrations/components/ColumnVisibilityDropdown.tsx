  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:ring-2 focus:ring-[var(--default-primary)] focus:border-transparent outline-none"
      >
              ...
              return (
                ...
                >
                  <input
                    ...
                    className="w-4 h-4 text-[var(--default-primary)] border-gray-300 rounded focus:ring-[var(--default-primary)]"
                  />
