        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex flex-col gap-4">
            {/* <button
              ...
              className="w-fit flex items-center gap-2 px-4 py-2 bg-[var(--default-primary)] text-white rounded-lg hover:bg-[#1E4A63] transition-colors duration-200 shadow-md hover:shadow-lg"
            >
              <svg 
                width="20" 
                height="20" 
          ...
          <div className="flex justify-between items-center gap-4">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[var(--default-primary)] focus:border-transparent outline-none"
              />
            </div>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 border rounded-lg transition-colors ${
                  hasActiveFilters
                    ? "border-[var(--default-primary)] bg-[var(--default-primary)] text-white"
              ...
              >
                ...
                Filter
                {hasActiveFilters && (
                  <span className="bg-white text-[var(--default-primary)] text-xs px-1.5 py-0.5 rounded-full font-medium">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-[var(--default-primary)] text-white rounded-lg hover:bg-[#1E4A63] transition-colors"
              >
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {filters.courses.map((course) => (
                  <span
                    key={course}
                    className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[var(--default-primary)] text-white"
                  >
                    {course}
                    <button
                      onClick={() => {
