...
const CreateLiveAdmin: React.FC<CreateLiveAdminProps> = ({
  ...
  return (
    <div className="bg-white p-6 rounded-xl w-full max-w-2xl">
      <h2 className="text-xl font-bold text-[var(--primary-500)] mb-4">
        {isEditMode ? "Edit Live Session" : "Create Upcoming Session"}
      </h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        {/* Topic Name */}
        <div>
          <label className="block text-sm font-medium text-[var(--primary-500)] mb-1">
            Title
          </label>
          <input
            type="text"
        ...
        <div className="flex justify-end mt-4 space-x-4">
          ...
          <button
            type="submit"
            className="bg-[var(--primary-500)] hover:bg-[var(--primary-600)] text-[var(--font-light)] font-medium py-2 px-4 rounded"
          >
