    ...
    <div className="w-full h-[380px] flex flex-col">
      <div className="flex-1 overflow-y-auto p-4 rounded-lg space-y-6">
        ...
        <div className="flex flex-col md:flex-row border border-gray-300 rounded-lg p-4 items-start md:items-center justify-between gap-4">
          ...
          <button
            onClick={handleSave}
            className="h-10 px-4 mt-2 md:mt-6 bg-[var(--primary-500)] text-[var(--font-light)] rounded-xl transition hover:bg-[var(--primary-600)] disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <div className="border border-gray-300 rounded-lg flex flex-col items-center justify-center py-10">
          ...
          <button
            ...
            className="mt-4 px-6 py-2 bg-[var(--primary-500)] text-[var(--font-light)] rounded-xl transition hover:bg-[var(--primary-600)]"
          >
            Add New {label}
          </button>
        </div>
