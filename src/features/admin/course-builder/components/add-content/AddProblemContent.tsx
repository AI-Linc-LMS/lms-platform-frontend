    ...
    <div className="w-full space-y-6">
      ...
      <div className="border border-gray-300 rounded-lg p-2 px-4 space-y-4">
          ...
          <div className="flex-1 min-w-[220px]">
            ...
            <div className="relative" ref={languageDropdownRef}>
              <button
                ...
                className="w-full mt-1 flex items-center justify-between border border-gray-300 rounded-md px-3 py-2 text-sm bg-white hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-[var(--primary-500)]"
              >
                  ...
                  {languageOptions.map((lang) => (
                    ...
                    >
                      <input
                        ...
                        onChange={() => {}}
                        className="h-4 w-4 text-[var(--primary-500)] focus:ring-[var(--primary-500)] border-gray-300 rounded"
                      />
            ...
            {languages.length > 0 && (
              <div className="mt-2 flex flex-wrap gap-1">
                {languages.map((lang) => (
                  <span
                    key={lang}
                    className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-[var(--primary-50)] text-[var(--primary-500)]"
                  >
                    {lang}
                    <button
                      type="button"
                      ...
                      className="ml-1 inline-flex items-center justify-center h-4 w-4 rounded-full hover:bg-[var(--primary-500)] hover:text-[var(--font-light)] focus:outline-none"
                    >
        ...
        <div className="flex justify-end">
          <button
            onClick={handleSave}
            className="px-6 py-2 bg-[var(--primary-500)] text-[var(--font-light)] rounded-xl transition"
          >
            Save Content
          </button>
        </div>
