          ...
          <div className="border border-gray-300 rounded-lg p-1 px-4 space-y-4">
            <div className="rounded-lg p-2 px-4 flex flex-col md:flex-row gap-6">
              ...
              <div className="w-full md:w-1/4">
                  ...
                  {questions.map((_, idx) => (
                    <button
                      ...
                      className={`w-15 h-10 rounded bg-white border ${
                        activeIndex === idx
                          ? "border-[var(--primary-500)] text-[var(--primary-500)] font-bold"
                ...
                <button
                  className="mt-4 px-3 py-1 border border-[var(--primary-500)] text-[var(--primary-500)] rounded flex items-center gap-1 text-sm hover:bg-[var(--primary-500)] hover:text-[var(--font-light)]"
