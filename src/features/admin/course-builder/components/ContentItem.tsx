  ...
  return (
    <div className="flex items-center justify-between border-b border-gray-200 py-2">
      <div className="flex items-center gap-2">
        ...
        <div>
          <div className="text-sm font-medium text-[var(--primary-500)]">
            {title}
          </div>
          {/* {marks !== undefined && (
      ...
      <div className="flex gap-2">
        ...
        <button
          className="bg-blue-50 text-[#17627A] border-1 border-[var(--primary-500)] rounded-md px-4 py-3 hover:bg-[#C9C9C9]"
          onClick={() => onEdit(id)}
        >
