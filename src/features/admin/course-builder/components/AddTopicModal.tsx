            ...
            <div className="mb-4">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  <span
                    className={
                      formData.week ? "text-gray-900" : "text-gray-500"
                    }
                  >
                    ...
                    {weekOptions.map((option) => (
                      <button
                        ...
                        className={`w-full text-left px-3 py-2 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none ${
                          formData.week === option.value
                            ? "bg-[#17627A] text-[var(--font-light)] hover:bg-[var(--primary-800)]"
                            : "text-gray-900"
                        }`}
                      >
                        {option.label}
              ...
              <input type="hidden" name="week" value={formData.week} required />
            </div>
