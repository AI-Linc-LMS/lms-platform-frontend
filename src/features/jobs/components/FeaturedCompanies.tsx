  ...
  return (
    <div className="bg-white rounded-2xl border border-[#DEE2E6] p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-[var(--neutral-500)] mb-2">
            Featured Companies
          </h2>
        ...
        <button className="px-4 py-2 text-[var(--primary-500)] border border-[var(--primary-500)] rounded-lg hover:bg-[var(--primary-500)] hover:text-[var(--font-light)] transition-colors font-medium">
          View All Companies
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        {mockCompanies.map((company) => (
          <div
            key={company.id}
            className="group relative p-4 rounded-xl border border-[var(--neutral-50)] hover:border-[var(--primary-500)] hover:shadow-md transition-all duration-200 cursor-pointer bg-white"
          >
            {/* Company Logo */}
            <div className="w-16 h-16 mx-auto mb-3 rounded-xl overflow-hidden bg-[var(--neutral-50)] flex items-center justify-center group-hover:scale-105 transition-transform">
              <img
                src={company.logo}
              ...
              />
              <div className="hidden text-[var(--neutral-300)] font-semibold text-xl">
            ...
            <div className="text-center">
              <h3 className="font-semibold text-[var(--neutral-500)] mb-1 text-sm leading-tight">
                {company.name}
              </h3>
              <p className="text-[var(--neutral-300)] text-xs mb-2 line-clamp-2">
                {company.description}
              </p>

              {/* Open Positions Badge */}
              <div className="inline-flex items-center gap-1 px-2 py-1 bg-[var(--primary-500)] bg-opacity-10 text-[var(--primary-500)] rounded-full text-xs font-medium">
                <svg
                  className="w-3 h-3"
                  fill="none"
                  stroke="currentColor"
            ...
            <div className="absolute inset-0 bg-[var(--primary-500)] bg-opacity-95 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200 p-4 flex flex-col justify-center items-center text-[var(--font-light)] text-center">
              ...
              <button className="mt-3 px-3 py-1 bg-white text-[var(--primary-500)] rounded-md text-xs font-medium hover:bg-gray-100 transition-colors">
                View Jobs
              </button>
            </div>
          </div>
      ...
      <div className="mt-6 pt-6 border-t border-[var(--neutral-50)]">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          ...
          <div>
            ...
            <div className="text-[var(--neutral-300)] text-sm">Active Jobs</div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="text-[var(--neutral-300)] text-sm">User Rating</div>
          </div>
        </div>
      </div>
    </div>
