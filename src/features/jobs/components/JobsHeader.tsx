    ...
    <div className="bg-white rounded-2xl border border-[#DEE2E6] p-6 md:p-8 mb-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="relative">
          <div className="bg-gradient-to-br from-[var(--primary-500)] to-[#17627A] rounded-2xl p-8 text-[var(--font-light)] relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-[var(--font-light)] text-opacity-80 text-sm">
              ...
              <button className="mt-6 w-full py-3 bg-white text-[var(--primary-500)] rounded-lg font-medium hover:bg-gray-100 transition-colors">
                Get Started Now
              </button>
            </div>
          </div>
