    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl max-w-md w-full p-6 sm:p-8 text-center">
        ...
        <div className="mb-6">
          <div className="w-16 h-16 bg-[#E8F4F8] rounded-full flex items-center justify-center mx-auto mb-4">
            <svg
              ...
              className="h-8 w-8 text-[var(--default-primary)]"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <div className="text-[var(--netural-300)] space-y-3 mb-6">
            {assessmentData?.status === "submitted" ? (
              <p>
                Your results for the{" "}
                <span className="font-semibold text-[var(--default-primary)]">
                  {job.title}
                </span>{" "}
            ...
            <div className="bg-gradient-to-r from-[#E8F4F8] to-[#F0F8FF] rounded-lg p-4 border-l-4 border-[var(--default-primary)]">
              <p className="text-[var(--default-primary)] font-medium">
          ...
          <div className="bg-[var(--netural-50)] rounded-lg p-4 mb-6 border border-[#DEE2E6]">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            onClick={onClose}
            className="flex-1 px-4 py-3 border border-[var(--netural-300)] text-[var(--netural-300)] rounded-lg hover:bg-[var(--netural-300)] hover:text-white transition-colors"
          >
            Cancel
          </button>
          <button
            ...
            className={`flex-1 px-4 py-3 rounded-lg transition-colors ${
              assessmentData?.status === "submitted"
                ...
                : "bg-[var(--default-primary)] text-white hover:bg-[#1E4A63]"
            }`}
          >
            {assessmentData?.status === "submitted"
              ? "View Results"
