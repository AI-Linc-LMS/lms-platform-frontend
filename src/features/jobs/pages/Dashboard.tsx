...
const Dashboard: React.FC = () => {
  const [activeTab, setActiveTab] = useState<
    "applications" | "bookmarks" | "searches"
  >("applications");
  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      const appliedJobsWithData = appliedJobData
        .map((app) => {
      ...
      const bookmarkedJobsWithData = bookmarkedJobIds
        .map((jobId) => {
  ...
  const JobCard: React.FC<{ job: Job; type: "application" | "bookmark" }> = ({
    job,
    type,
  }) => (
      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            title={
              type === "application" ? "Remove application" : "Remove bookmark"
            }
          >
            <svg
              className="w-5 h-5"
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center justify-between">
          ...
          <p className="text-xs text-gray-500">
            {type === "application" ? "Applied" : "Bookmarked"}{" "}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Track your job applications, bookmarks, and saved searches
          </p>
        </div>
          ...
          <div>
            {savedSearches.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Save your search queries to quickly find them later.
                </p>
              </div>
            ) : (
