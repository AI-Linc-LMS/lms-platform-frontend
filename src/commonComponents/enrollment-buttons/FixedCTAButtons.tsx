...
const FixedCTAButtons: React.FC<FixedCTAButtonsProps> = ({
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 w-full max-w-md mx-auto p-2">
      <button
        onClick={onEnroll}
        className="w-full sm:w-[200px] py-3 sm:py-4 px-4 text-xl font-semibold text-[var(--font-light)] bg-green-600 hover:bg-green-700 rounded-lg sm:rounded-xl transition-colors duration-200"
      >
        Enroll Now
      </button>
      <button
