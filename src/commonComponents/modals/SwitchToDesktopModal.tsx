...
const SwitchToDesktopModal: React.FC<SwitchToDesktopModalProps> = ({
  isOpen,
  onClose,
}) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative bg-white rounded-2xl p-6 w-full max-w-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex">
              {[...Array(5)].map((_, i) => (
                <svg
                  key={i}
                  className="w-4 h-4 text-[var(--primary-200)]"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <p className="text-center text-gray-600">
          For the best experience, please use a laptop or desktop to access the
          dashboard.
        </p>
      </div>
    </div>
