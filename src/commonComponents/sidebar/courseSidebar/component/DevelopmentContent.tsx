        ...
        {projects.map((project) => (
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                className="h-[30px] ml-4 px-3 py-1 text-xs bg-[var(--default-primary)] hover:bg-[#344b5a] text-white rounded-md transition transform hover:scale-105 cursor-pointer"
                onClick={(e) => {
                  e.stopPropagation();
