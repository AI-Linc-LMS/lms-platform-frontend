          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
            <div className="relative max-w-md">
              <input
                ...
                className="w-full pl-10 pr-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--primary-500)] focus:border-[var(--primary-500)] text-sm sm:text-base"
              />
              <svg
              ...
              >
                ...
                <div className="space-y-2">
                  <button
                    ...
                    className="w-full bg-[var(--primary-500)] text-[var(--font-light)] py-2 px-3 sm:px-4 rounded-lg hover:bg-[var(--primary-600)] hover:scale-105 hover:shadow-lg transition-all duration-200 flex items-center justify-center gap-1 sm:gap-2 transform active:scale-95 text-xs sm:text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                ...
                <div className="flex flex-row items-center justify-between gap-3">
                  <div>
                    <button
                      ...
                      className="flex items-center justify-center w-10 h-10 sm:w-auto sm:h-10 sm:px-4 text-sm rounded-xl text-[var(--font-light)] bg-[var(--primary-500)] font-medium transition-all duration-200 hover:bg-[var(--primary-600)] hover:scale-105 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transform active:scale-95"
                    >
                      <svg
                  ...
                  <div>
                    <button
                      ...
                      disabled={isDownloading}
                      className="flex items-center justify-center w-10 h-10 sm:w-auto sm:h-10 text-sm rounded-xl text-[var(--font-light)] bg-[var(--primary-500)] font-medium transition-all duration-200 hover:bg-[var(--primary-600)] hover:scale-105 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transform active:scale-95"
                    >
                      {isDownloading ? (
                        <>
                          <svg
                            className="animate-spin w-5 h-5 sm:w-4 sm:h-4 text-[var(--font-light)]"
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                          >
