...
const WebinarManagement: React.FC = () => {
  ...
  const [editingWorkshop, setEditingWorkshop] =
    useState<WorkshopVariable | null>(null);
  ...
  const extractSessionNumber = (sessionString: string | number) => {
    ...
    if (
      ...
      sessionString.startsWith("Session-")
    ) {
  ...
  const fetchWorkshops = async () => {
    try {
      ...
      const workshopsWithIds = workshopData.map(
        (workshop: WorkshopResponse, index: number) => ({
          ...workshop,
  ...
  const handleEdit = (workshop: WorkshopVariable) => {
    ...
    setFormData({
      ...
      UpcomingWorkshopDate: formatDateForInput(
        workshop.UpcomingWorkshopDate || ""
      ),
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          {/* <button
            ...
            disabled={true}
            className="bg-gray-400 cursor-not-allowed text-[var(--font-light)] px-6 py-3 rounded-lg font-medium"
          >
            + Create New Workshop
          </button> */}
        </div>
          ...
          <div className="mb-8 lg:mb-10 bg-white rounded-2xl shadow-xl border border-gray-100 p-6 lg:p-8 backdrop-blur-sm">
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-6 h-6 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center">
                <svg
                  className="w-4 h-4 text-[var(--font-light)]"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          UpcomingWorkshopDate: e.target.value,
                        })
                      }
                      className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all duration-200 text-sm lg:text-base font-medium"
                      required
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          ZoomJoiningLink: e.target.value,
                        })
                      }
              ...
              <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 pt-6 border-t border-gray-100">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-[var(--font-light)] px-8 py-3 rounded-xl font-semibold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-sm lg:text-base shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                >
                  {loading ? (
            ...
            <>
                      ...
                      >
                        ...
                        <td className="px-8 py-6 whitespace-nowrap">
                          <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800 border border-blue-200">
                            {typeof workshop.SessionNumber === "string"
                              ? workshop.SessionNumber
                              : `Session ${workshop.SessionNumber}`}
                          </span>
                        </td>
                        ...
                        <td className="px-8 py-6 whitespace-nowrap text-sm font-medium">
                          <button
                            ...
                            disabled={loading}
                            className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-[var(--font-light)] rounded-lg font-medium hover:from-indigo-600 hover:to-purple-700 disabled:opacity-50 transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
                          >
                            <svg
              ...
              <div className="lg:hidden">
                {workshops.map((workshop, index) => (
                  <div
                    key={workshop.id || index}
                    className="border-b border-gray-100 p-6 hover:bg-gray-50 transition-colors duration-150"
                  >
                    <div className="space-y-4">
                      ...
                      <div className="pt-4 border-t border-gray-100">
                        <button
                          onClick={() => handleEdit(workshop)}
                          disabled={loading}
                          className="w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 text-[var(--font-light)] rounded-xl font-semibold hover:from-indigo-600 hover:to-purple-700 disabled:opacity-50 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                        >
                          <svg
