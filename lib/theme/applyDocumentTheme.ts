...
export const CAMEL_TO_CSS: [keyof NormalizedTheme | string, string][] = [
  ...
  ["moduleTileTo", "module-tile-to"],
  ["profileHeroFrom", "profile-hero-from"],
  ["profileHeroMid", "profile-hero-mid"],
  ["profileHeroTo", "profile-hero-to"],
  ["profileHeroGlow", "profile-hero-glow"],
  ["profileHeroGlow2", "profile-hero-glow-2"],
  ["authAccent", "auth-accent"],
  ["authAccentDeep", "auth-accent-deep"],
  ["authAccentSoft", "auth-accent-soft"],
  ["authAccentAlt", "auth-accent-alt"],
  ["authNight", "auth-night"],
  ["authNight2", "auth-night-2"],
  ["authGlow", "auth-glow"],
  ["authGlowDeep", "auth-glow-deep"],
  ["authGlowSoft", "auth-glow-soft"],
  ["authScrim", "auth-scrim"],
  ["authScrim2", "auth-scrim-2"],
  ["authOnAccent", "auth-on-accent"],
  ["authLink", "auth-link"],
  ["authWash", "auth-wash"],
  ["authWash2", "auth-wash-2"],
  ["authBrandFrom", "auth-brand-from"],
  ["authBrandTo", "auth-brand-to"],
